...
const LandScape = () => {
    ...
    return (
        <div className={classes.page}>
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="190" viewBox="0 0 331 308" fill="none">
                <path
            ...
            {/*Крайний правый*/}
            <svg style={{position: "absolute", top: "-20%", right: "0", zIndex: "0"}} xmlns="http://www.w3.org/2000/svg"
            ...
            {/*Средний левый*/}
            <svg style={{position: "absolute", top: "-20%", left: "17%", zIndex: "1"}}
            ...
            {/*Крайний левый*/}
            <svg style={{position: "absolute", top: "-25%", left: "22%"}} xmlns="http://www.w3.org/2000/svg" width="366"
            ...
            <svg style={{position: "absolute", top: "0", right: "25%"}} xmlns="http://www.w3.org/2000/svg" width="168"
                 height="167" viewBox="0 0 218 217" fill="none">
            ...
            {/*Большой левый*/}
            <svg style={{position: "absolute", left: "-3%"}} xmlns="http://www.w3.org/2000/svg" width="351" height="802"
            ...
            {/*Большой зеленый*/}
            <svg style={{position: "absolute", right: "15%", top: "-15%"}} xmlns="http://www.w3.org/2000/svg"
                 width="203" height="218" viewBox="0 0 303 288" fill="none">
            ...
            <svg style={{position: "absolute", bottom: "-25%", right: "0"}} xmlns="http://www.w3.org/2000/svg"
                 width="170" height="477" viewBox="0 0 170 477" fill="none">
            ...
            <svg style={{position: "absolute", top: "-15%", left: "0"}} xmlns="http://www.w3.org/2000/svg" width="283"
                 height="374" viewBox="0 0 373 464" fill="none">
            ...
            <svg style={{position: "absolute", bottom: "-15%", left: "0%"}} xmlns="http://www.w3.org/2000/svg"
                 width="272" height="428" viewBox="0 0 302 528" fill="none">
            ...
            {/*Листик снизу*/}
            <svg style={{position: "absolute", bottom: "-25%", left: "10%"}} xmlns="http://www.w3.org/2000/svg" width="703" height="300" viewBox="0 0 703 300" fill="none">
