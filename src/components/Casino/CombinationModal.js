    ...
    return (
        <div className="combination-overlay">
            ...
            <div className="combination-content">
                <svg onClick={close} style={{position: "absolute", top: "-2.5vh", left: "93%"}}
                     xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 86 86" fill="none">
                    <circle cx="43" cy="43" r="43" fill="url(#paint0_linear_501_1257)"/>
                    <g filter="url(#filter0_d_501_1257)">
                        <path d="M26.041 26.041L58.9577 58.9577M26.041 58.9577L58.9577 26.041" stroke="#212121"
                              stroke-width="7" stroke-linecap="round" stroke-linejoin="round"
                              shape-rendering="crispEdges"/>
                    </g>
                    <defs>
                        <filter id="filter0_d_501_1257" x="12.541" y="12.541" width="59.916" height="59.916"
                                filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                            <feColorMatrix in="SourceAlpha" type="matrix"
                            ...
                            <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_501_1257"/>
                            <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_501_1257" result="shape"/>
                        </filter>
                        <linearGradient id="paint0_linear_501_1257" x1="86" y1="0" x2="0" y2="86"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#4CAF50"/>
                            <stop offset="1" stop-color="#FFEB3B"/>
                        </linearGradient>
